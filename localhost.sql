...
--
-- Host: localhost
-- Generation Time: 12 فبراير 2025 الساعة 19:24
...
--
-- إرجاع أو استيراد بيانات الجدول `his_accounts`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_admin`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_docs`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_equipments`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_laboratory`
--
...
--
-- بنية الجدول `his_medical_records`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_medical_records`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_patients`
--
...
--
-- بنية الجدول `his_patient_transfers`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_patient_transfers`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_payrolls`
--
...
--
-- بنية الجدول `his_pharmaceuticals`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_pharmaceuticals`
--
...
--
-- بنية الجدول `his_pharmaceuticals_categories`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_pharmaceuticals_categories`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_prescriptions`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_surgery`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_vendor`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `his_vitals`
--
...
('root', '2025-02-12 18:23:36', '{\"lang\":\"ar\",\"Console\\/Mode\":\"collapse\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Database: `selcuksozluk`
--
CREATE DATABASE IF NOT EXISTS `selcuksozluk` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `selcuksozluk`;
...
CREATE TABLE `post` (
  ...
  `post_title` varchar(280) NOT NULL,
...
CREATE TABLE `post_comment` (
  ...
  `post_comment_title` varchar(280) NOT NULL,
  `post_comment_image` varchar(50) NOT NULL,
...
--
-- بنية الجدول `post_comment_review`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `post_comment_review`
--
...
--
-- إرجاع أو استيراد بيانات الجدول `post_review`
--
...
CREATE TABLE `users` (
  ...
  `profile_picture` varchar(50) NOT NULL DEFAULT 'default',
  `banner_picture` varchar(50) NOT NULL DEFAULT 'default',
...
--
-- إرجاع أو استيراد بيانات الجدول `user_follow`
--
...
CREATE TABLE `user_role` (
  ...
  `user_role_title` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
--
-- Indexes for table `post_comment_review`
--
...
--
-- AUTO_INCREMENT for table `post_comment_review`
--
ALTER TABLE `post_comment_review`
...
-- Database: `shwky`
--
CREATE DATABASE IF NOT EXISTS `shwky` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `shwky`;
